...
def P_Aggregation_Demograph(part_list):
    ...
    for parts in part_list:
        ...
        part = pd.read_csv(f'/Users/DAHS/Desktop/hirid-a-high-time-resolution-icu-dataset-1.1.1/raw_stage/tabular_records/csv_labeling/part-{parts}.csv')
    ...
    result = result.rename(columns = {'sex':'Sex', 'age':'Age', 'Platelet_count':'Platelet_Count', 'Platelet_count_up':'Platelet_Count_up', 'Urine_output':'Urine_Output'})
    print('=======')
    ...
    print('=======')
    result.to_csv(local + 'hirid.csv.gz',index=False)
